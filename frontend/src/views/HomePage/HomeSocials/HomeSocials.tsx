...
function HomeSocials(props: IHomeSocialsProps) {
    return (
        <ul className="home-socials" aria-label={props.label}>
            {socialLinks.map((socialLink) => (
                <li className="home-socials__item" key={socialLink.label}>
                    <a
                        className={socialLink.stroke ? "home-socials__link home-socials__link--stroke" : "home-socials__link"}
                    ...
                    >
                        <svg
                            className={socialLink.stroke ? "home-socials__icon home-socials__icon--stroke" : "home-socials__icon"}
