...
import "./HomeMobileGallery.scss";

interface IHomeMobileGalleryProps {
    label: string;
    ariaLabel: string;
}

function HomeMobileGallery(props: IHomeMobileGalleryProps) {
    return (
        <Link className="home-mobile-gallery" href="/gallery" aria-label={props.ariaLabel}>
            <span className="home-mobile-gallery__text">{props.label}</span>
            <span className="home-mobile-gallery__line" />
            <span className="home-mobile-gallery__symbol" aria-hidden="true">
                <svg className="home-mobile-gallery__icon" viewBox="0 0 30 30">
...
export default HomeMobileGallery;
